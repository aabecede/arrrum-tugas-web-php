      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.php" class="h2 mb-0">Pembelajaran<span
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="#blog-section" class="nav-link">Materi</a></li>
    ...
    <section class="site-section" id="about-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12 mr-auto mb-12">
      ...
      <div class="container">
        <div class="row justify-content-center" data-aos="fade-up">
          <div class="col-lg-6 text-center mb-5">
            ...
            <h2 class="text-black mb-2">Materi Pembelajaran</h2>
            <!-- <p>
        ...
        <div class="row">
          ...
          <!-- <div class="col-md-6 mb-4" data-aos="fade-up"  data-aos-delay="100">
            <div class="d-lg-flex blog-entry">
              <figure class="mr-4">
                <a href="single.html"><img src="images/pemusatan-data-2.png" alt="Image" class="img-fluid rounded"></a>
              </figure>
              <div class="blog-entry-text">
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="mb-4 mb-lg-0 col-md-6 col-lg-4">
            <p class="mb-0 font-weight-bold text-primary">Alamat</p>
            <p class="mb-4">Kediri, Bandar Lor Gang III 19 C
          </div>
          <div class="mb-4 mb-lg-0 col-md-6 col-lg-4">
            <p class="mb-0 font-weight-bold text-primary">Phone</p>
            <p class="mb-4"><a href="#">+085608129137</a></p>
          </div>
          <div class="mb-4 mb-lg-0 col-md-6 col-lg-4">
            <p class="mb-0 font-weight-bold text-primary">Email Address</p>
            <p class="mb-0"><a href="#">aab.peezz@gmail.com</a></p>
          </div>
        </div>
      </div>
    </div> -->
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="mb-5">
              ...
              <a href="https://instagram.com/ayumdoubleru?utm_medium=copy_link" target="_blank" class="pl-3 pr-3"><span
          ...
          <div class="col-md-12">
            <div class="border-top pt-5">
              ...
              <p>Copyright &copy;
                ...
                </script> Created by <a href="https://github.com/abuduru" target="_blank">abuduru <i
                    class="icon-heart-o" aria-hidden="true"></i></a>
              </p>
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
